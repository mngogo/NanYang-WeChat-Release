...
.row
  ...
  .btn.btn-up(v-if='!disabled_edit')
      .card-title(style='color:black;text-align:left;') 租赁合同
  ...
  .btn.btn-up(style='margin-top: 140px;' v-if='!disabled_edit')
      .card-title(style='color:black;text-align:left;') 公司提供无住房证明
...
//    this.myChildren.push(this.child)
    ...
    submitData (e) {
      ...
      if(!this.basicData.poXm||!this.basicData.xb||!this.basicData.csny||!this.basicData.jg ||!this.basicData.sfz||!this.basicData.sqcc||!this.basicData.xgzdw||!this.basicData.sjhm||!this.basicData.sqlb||!this.basicData.remark||!this.basicData.yhzh||!this.basicData.gzMonth||!this.basicData.btbz||!this.basicData.btje){
        return;
      }
       this.startvlwc=false;
